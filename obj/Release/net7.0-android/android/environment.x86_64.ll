...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"871a555f-fcc1-49f5-b6b2-01d57ca8c4b3\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [28 x i8] c"com.companyname.fitnesstest\00", align 16
...
@__DSOCacheEntry_name.47 = internal constant [26 x i8] c"libaot-FitnessTest.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 56
	%struct.DSOCacheEntry {
		i64 2499712234569918409, ; hash 0x22b0c308863ce7c9, from name: libaot-FitnessTest
		i8 0, ; ignore
	...
	; 76
	%struct.DSOCacheEntry {
		i64 3318082168141693281, ; hash 0x2e0c3226e7a4c161, from name: FitnessTest
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.47, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 147
	%struct.DSOCacheEntry {
		i64 6915655294082050148, ; hash 0x5ff957d968cf6864, from name: FitnessTest.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.47, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 182
	%struct.DSOCacheEntry {
		i64 8130668629621498907, ; hash 0x70d5f00a5f00641b, from name: libaot-FitnessTest.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.47, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 193
	%struct.DSOCacheEntry {
		i64 8487276998100179726, ; hash 0x75c8dd76561adb0e, from name: aot-FitnessTest.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.47, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 286
	%struct.DSOCacheEntry {
		i64 11800543000708982528, ; hash 0xa3c3f35651fb2700, from name: aot-FitnessTest
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.47, i32 0, i32 0), ; name
		i8* null; handle
	}, 
