...
@__DSOCacheEntry_name.22 = internal constant [26 x i8] c"libaot-FitnessTest.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 23
	%struct.DSOCacheEntry {
		i64 255492810, ; hash 0xf3a82ca, from name: FitnessTest
		i8 0, ; ignore
	...
	; 123
	%struct.DSOCacheEntry {
		i64 1277229092, ; hash 0x4c20f824, from name: FitnessTest.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 137
	%struct.DSOCacheEntry {
		i64 1373162744, ; hash 0x51d8ccf8, from name: libaot-FitnessTest
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 151
	%struct.DSOCacheEntry {
		i64 1428459387, ; hash 0x55248f7b, from name: aot-FitnessTest
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 210
	%struct.DSOCacheEntry {
		i64 2020918374, ; hash 0x7874c466, from name: libaot-FitnessTest.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 371
	%struct.DSOCacheEntry {
		i64 3375879128, ; hash 0xc937d3d8, from name: aot-FitnessTest.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.22, i32 0, i32 0), ; name
		i8* null; handle
	}, 
